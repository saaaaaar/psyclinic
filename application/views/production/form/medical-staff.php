          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Silahkan lakukan registrasi perawat baru dengan mengisikan kelengkapan data psikiater atau perawat pada kolom isian di bawah ini: </h2>
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" class="form-horizontal form-label-left" method="POST" action="<?php echo base_url('admin/tambah')?>">
                      ...
                      <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                        ...
                        <select class="form-control" name="kode_akses" required="">
                          ...
                          <option value="2">Psikiater</option>
                        </select>
                      </div>
                      ...
                      <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                        <label>Email</label>
                        <input type="email" name="email" class="form-control" placeholder="example@igniter.com">
                      </div>
