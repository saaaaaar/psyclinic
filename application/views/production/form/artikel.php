            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form action="<?=base_url('C_News/insert_posting');?>" method="post" enctype="multipart/form-data">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                        ...
                        <input type="date" class="form-control" name="tanggal_post" required="">
                      </div>
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                        <label>Isi*</label>
                        <textarea class="form-control" placeholder="Isikan artikel Anda" name="isi" rows="4" required=""></textarea>
                      </div>
