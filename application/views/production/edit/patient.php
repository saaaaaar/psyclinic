              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" class="form-horizontal form-label-left" action="<?php echo base_url('Perawat/update')?>" method="POST">
                      
                      <?php foreach($pasien as $p){?>
                      <div class="col-md-4 col-sm-3 col-xs-12 form-group">
                        <label>Tanggal Masuk*</label>
                        <input type="date" name="tanggal_masuk" class="form-control" required="" value="<?php echo $p['tanggal_masuk']?>">
                      </div>
                      
                      <div class="col-md-4 col-sm-5 col-xs-12 form-group">
                        <label>No. RM</label>
                        <input type="text" name="no_rm" class="form-control" required="" value="<?php echo $p['no_rm']?>">
                      </div>

                      <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                        <label>No Identitas* <small style="padding-left: 10px;">Ex: 9990906189231076</small></label>
                        <input type="text" class="form-control" name="no_id" required="" value="<?php echo $p['no_identitas']?>">
                      </div>

                      <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                        <label>Nama Lengkap*</label>
                        <input type="hidden" class="form-control" name="id_pasien" required="" value="<?php echo $p['id_pasien']?>">
                        <input type="text" class="form-control" name="nama" required="" value="<?php echo $p['nama']?>">
                      </div>
                      ...
                      <div class="col-md-3 col-sm-3 col-xs-12 form-group">
                        ...
                        <select class="form-control" name="agama">
                          ...
                          <option <?php if($agama == "Kristen"){ echo "selected";}?> value="Kristen">Kriten</option>
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                        ...
                        <div style="padding-top: 6px;">
                          <input type="radio" class="flat" <?php if($p['jenis_kelamin'] == "Perempuan"){ echo "checked";}?> name="gender" value="Perempuan">
                          <a>Perempuan</a>
                          <input type="radio" class="flat" <?php if($p['jenis_kelamin'] == "Laki-Laki"){ echo "checked";}?> name="gender" value="Laki-Laki">
                          <a>Laki-Laki</a>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                        ...
                        <div style="padding-top: 6px;">
                          <input type="radio" class="flat" <?php if($p['pernikahan'] == "Menikah"){ echo "checked";}?> name="status" value="Menikah">
                          <a>Menikah</a>
                          <input type="radio" class="flat" <?php if($p['pernikahan'] == "Belum Menikah"){ echo "checked";}?> name="status" value="Belum Menikah">
                          <a>Belum Menikah</a>
                        </div>
                      </div>
                      ...
                      <div class="col-md-9 col-sm-12 col-xs-12 form-group">
                        <label>Alamat*</label>
                        <textarea class="form-control" placeholder="isikan alamat anda sekarang" name="alamat" rows="4" required=""><?php echo $p['alamat']?></textarea>
                      </div>
                      ...
                      <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                        <label>Nama Lengkap</label>
                        <input type="text" name="nama_penanggung" class="form-control" value="<?php echo $p['nama_penanggung']?>">
                      </div>

                      <div class="col-md-3 col-sm-6 col-xs-12 form-group">
                        <label>No. Telepon/HP</label>
                        <input type="text" name="no_telp_penanggung" class="form-control" value="<?php echo $p['no_telp_penanggung']?>">
                      </div>

                      <div class="col-md-3 col-sm-6 col-xs-12 form-group">
                        <label>Hubungan</label>
                        <input type="text" name="hubungan" class="form-control" value="<?php echo $p['hubungan']?>">
                      </div>

                      <div class="col-md-4 col-sm-6 col-xs-12 form-group">
                        <label style="padding-right: 10px;">Jenis Kelamin</label>
                        <div style="padding-top: 6px;">
                          <input type="radio" class="flat" <?php if($p['jenis_kelamin_penanggung'] == "Perempuan"){ echo "checked";}?> name="gender_penanggung" value="Perempuan">
                          <a>Perempuan</a>
                          <input type="radio" class="flat" <?php if($p['jenis_kelamin_penanggung'] == "Laki-Laki"){ echo "checked";}?> name="gender_penanggung" value="Laki-Laki">
                          <a>Laki-Laki</a>
                        </div>
                      </div>
                      ...
                      <div class="col-md-9 col-sm-12 col-xs-12 form-group">
                        <label>Alamat*</label>
                        <textarea class="form-control" placeholder="isikan alamat anda sekarang" name="alamat_penanggung" rows="4" required=""><?php echo $p['alamat_penanggung']?></textarea>
                      </div>
